...
const getPath = (name, props) => {
  ...
  v61.7l-16,7.3V18.8z M76,73.2l-15,7.3V18.8l15-7.3V73.2z" {...props}/>
    ...
    case 'trophy':
      return <path id="XMLID_2061_" d="M54,28.2v-8.9c0-1.9,1.6-3.5,3.5-3.5s3.5,1.6,3.5,3.5v8.9c0,1.9-1.6,3.5-3.5,3.5S54,30.1,54,28.2z
  ...
  v25.9c0,14.5,9.8,19.6,19,19.6s19-5.2,19-19.6V12z M78.7,33.2c3.9-4,5.3-10.2,5.7-15.2H73v18.5C75,35.9,77.1,34.8,78.7,33.2z" {...props}/>;
